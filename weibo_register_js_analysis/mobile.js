...
STK.register("ui.mask",
function(a) {
    function k(b) {
        var c; (c = b.getAttribute(f)) || b.setAttribute(f, c = a.getUniqueKey());
...
function(a) {
    ...
    e, f = function() {
        ...
        a.custEvent.add(b, "show",
        function() {
            a.ui.mask.showUnderNode(b.getOuter())
        });
        a.custEvent.add(b, "hide",
        function() {
            a.ui.mask.back();
            b.setMiddle()
        });
...
STK.register("kit.io.ajax",
function(a) {
    var b = function(b, c, d) {
        c = c | 0 || 1;
        d = d || "fail";
        var e = b.args;
        e.__rnd && delete e.__rnd; (new Image).src = "http://weibolog.sinaapp.com/?t=" + c + "&u=" + encodeURIComponent(b.url) + "&p=" + encodeURIComponent(a.core.json.jsonToQuery(e)) + "&m=" + d
    };
    return function(c) {
        var d = {},
        e = [],
...
STK.register("pl.base.lang.source.main",
function(a) {
...
STK.pageletM.register("pl.base.lang.index",
function(a) {
...
function SSOController() {
    ...
    ssoPreLoginUrl = "http://login.sina.com.cn/sso/prelogin.php",
    ...
    this.init = function() {
        ...
        me.isCheckLoginState && addEventListener(window, "load",
        function() {
            me.checkLoginState()
        });
    ...
    this.login = function(a, b, c) {
        ...
        loginByConfig = function() {
            ...
            if (me.useIframe && (me.setDomain || me.feedBackUrl)) {
                if (me.setDomain) {
                    document.domain = me.domain; ! me.feedBackUrl && me.domain != "sina.com.cn" && (me.feedBackUrl = makeURL(me.appLoginURL[me.domain], {
                        domain: 1
                    }))
                }
                loginMethod = "post";
    ...
    this.prelogin = function(a, b) {
		...
		console.error('prelogin')
                console.error(a.servertime+a.nonce)
		console.error(a.rsaPubkey)
		console.error(a.rsakv)
		console.error(a.pcid)
            }
    ...
    this.loginCallBack = function(a) {
        try {
            ...
            if (d) {
                ...
                if (me.feedBackUrl) me.crossDomain ? me.crossDomainAction("login",
                function() {
    ...
    this.updateCookieCallBack = function(a) {
        a.retcode == 0 ? me.crossDomainAction("update",
        function() {
...
STK.register("common.channel.sso.login",
function(a) {
...
STK.register("common.login.sso.loginbridge",
function(a) {
...
STK.pageletM.register("pl.plugin.sso.login.index",
function(a) {
...
STK.register("common.trans.form",
function(a) {
    var b = a.kit.io.inter(),
    c = b.register;
    c("checkform", {
...
STK.register("common.trans.account",
function(a) {
    var b = a.kit.io.inter(),
    c = b.register;
    c("btn_quick_opening", {
...
STK.register("common.setting.form",
function(a) {
...
STK.register("kit.extra.orderStr",
function(a) {
    return function(a, b) {
...
STK.register("common.setting.rule",
function(a) {
...
STK.register("common.setting.textCopy",
function(a) {
...
STK.register("kit.dom.parentElementBy",
function(a) {
    return function(a, b, c) {
...
STK.register("kit.extra.mobileCountry",
function(a) {
    var b = a.kit.extra.language;
    return function(c) {
        if (!a.isNode(c) || c.tagName.toLowerCase() != "select") throw "mobileCountry need select node!";
        var d = [b("#L{中国大陆}"), b("#L{香港地区}"), b("#L{澳门地区}"), b("#L{台湾地区}"), b("#L{美国}"), b("#L{加拿大}"), b("#L{巴西}"), b("#L{马来西亚}"), b("#L{澳洲}"), b("#L{日本}"), b("#L{韩国}"), b("#L{新加坡}"), b("#L{英国}"), b("#L{法国}"), b("#L{俄罗斯}"), b("#L{印度}"), b("#L{泰国}"), b("#L{德国}")],
        e = {};
        e[b("#L{中国大陆}")] = "0086";
        e[b("#L{香港地区}")] = "00852";
        e[b("#L{澳门地区}")] = "00853";
        ...
        a.foreach(d,
        function(a) {
            c.options[f++] = new Option(a, e[a])
        })
    }
});
STK.register("kit.extra.actionData",
function(a) {
    return function(b) {
        return {
            set: function(c, d) {
...
STK.register("kit.dom.layoutPos",
function(a) {
    return function(b, c, d) {
...
STK.register("common.setting.base",
function(a) {
    return function() {
        var b = {};
...
STK.register("common.setting.dataType",
function(a) {
    var b = a.kit.extra.language,
    c = {
        msg: {
...
STK.register("common.setting.control",
function(a) {
    return function(b, c, d) {
...
STK.register("common.extra.parseLanguage",
function(a) {
    var b, c = function(d) {
...
STK.register("common.setting.newmobilesea",
function(a) {
    var b = a.kit.dom.parentElementBy,
    c = a.kit.dom.parseDOM,
    d = a.kit.extra.mobileCountry,
    e = a.kit.extra.actionData,
    f = {
        E01: "",
        E02: "#L{请输入您的手机号码}",
        E03: "#L{请输入手机号码}",
        E04: "#L{手机号长度11位，以13/14/15/17/18开头}",
        E05: "#L{手机号格式不正确}",
        E06: "#L{手机号前不需要0}"
    };
    return function(d, g) {
        g = g || {};
        var h = b(d, document.body,
        function(a) {
            if (a.getAttribute("node-type") === "mobilesea_wrapper") return ! 0
        });
        if (!h) throw "mobilesea no wrapper";
        var i = c(a.builder(h).list),
        j = {};
        j.el = i.mobilesea_selectlayer.getElementsByTagName("li")[0];
        j.key = e(j.el).get("key");
        j.data = e(j.el).get("code");
        i.mobilesea_selectvalue.value = j.data;
        var k = function() {
            var a = r.value(),
            b = !1;
            if (!r.pars.must && r.rule.isEmpty(a)) {
                r.msg.state = !0;
                r.msg.type = "empty";
                r.msg.code = "E01"
            } else {
                if (!b && r.rule.isEmpty(a)) {
                    b = !0;
                    r.msg.type = "err";
                    r.msg.code = "E03"
                }
                var c = j.data;
                if (c === "0086") {
                    if (!b && !r.rule.isMobile(a)) {
                        b = !0;
                        r.msg.type = "err";
                        r.msg.code = "E04"
                    }
                } else {
                    if (c === "00886" && !b && a.indexOf("0") === 0) {
                        b = !0;
                        r.msg.type = "err";
                        r.msg.code = "E06"
                    }
                    if (!b && !r.rule.isMobileSea(a, c)) {
                        b = !0;
                        r.msg.type = "err";
                        r.msg.code = "E05"
                    }
        ...
        l = function(b) {
            if (j.el == b.el) {
                i.mobilesea_selectlayer.style.display = "none";
                a.removeClassName(i.mobilesea_select, "W_input_focus")
            } else {
                a.removeClassName(j.el, "select");
                a.addClassName(b.el, "select");
                a.removeClassName(i.mobilesea_select, j.key);
                j.el = b.el;
                j.key = b.data.key;
                j.data = b.data.code;
                a.addClassName(i.mobilesea_select, j.key);
                i.mobilesea_selectlayer.style.display = "none";
                a.removeClassName(i.mobilesea_select, "W_input_focus");
                var c = b.data.code;
                i.mobilesea_txt.innerHTML = c;
                i.mobilesea_selectvalue.value = j.data
            }
            var f = r.rule.reNullChar(d.value),
            g = e(d).get("text");
            if (f && (!g || f != g)) q.blur();
            else {
                a.kit.extra.textareaUtils.setCursor(d);
                d.value = ""
            }
            a.custEvent.fire(r, "change", j.data)
        },
        m = a.delegatedEvent(i.mobilesea_selectlayer);
        m.add("select", "click", l);
        var n = function(b) {
            var c = a.fixEvent(b).target;
            a.hasClassName(i.mobilesea_select, "W_input_focus") ? a.removeClassName(i.mobilesea_select, "W_input_focus") : a.addClassName(i.mobilesea_select, "W_input_focus");
            a.kit.dom.layoutPos(i.mobilesea_selectlayer, c);
            i.mobilesea_selectlayer.style.display = i.mobilesea_selectlayer.style.display == "" ? "none": ""
        },
        o = function(b) {
            var c = a.fixEvent(b).target;
            if (!a.contains(i.mobilesea_selectlayer, c) && c != i.mobilesea_select) {
                a.removeClassName(i.mobilesea_select, "W_input_focus");
                i.mobilesea_selectlayer.style.display = "none"
            }
        };
        a.addEvent(i.mobilesea_select, "click", n);
        a.addEvent(document.body, "click", o);
        var p, q = {
            focus: function() {
                a.addClassName(d.parentNode, "W_input_focus");
                r.cache_value = r.value();
                if (r.rule.isEmpty(r.cache_value)) {
                    r.msg.state = !1;
                    r.msg.action = "focus";
                    r.msg.type = "tip";
                    r.msg.code = "E02";
            ...
            blur: function() {
                a.removeClassName(d.parentNode, "W_input_focus");
                d.value = r.rule.reNullChar(d.value);
                r.msg.action = "blur";
                var b = r.value();
                if (b && r.pars.proxy && r.pars.iokey) {
                    var c = j.data + b;
                    if (c == p) return;
                    p = c
                }
                r.cache_value = null;
                if (r.pars.iodelay === 0 && !r.pars.proxy && !r.pars.iokey) {
                    k();
                    r.fire()
                } else ioDelay = setTimeout(function() {
                    k();
                    if (r.msg.state && r.pars.proxy && r.pars.iokey) {
                        r.msg.type = "loading";
                        r.pars.iorecords = !0;
                        r.pars.proxy.request(r.pars.iokey, {
                            onSuccess: function(b) {
                                r.msg = a.parseParam(r.msg, b.data || {});
                                r.msg.state = !0;
                                r.fire()
                            },
                            onError: function(b) {
        ...
        r = a.common.setting.control(d, g, {
            evtAct: q,
            check: k
        }),
        s = a.core.obj.sup(r, ["initPars"]);
        r.initPars = function() {
            s.initPars();
            r.errText = a.common.extra.parseLanguage(g.errText || f);
            r.type = "mobilesea";
            a.custEvent.define(r, ["change"])
        };
        r.getZone = function() {
            return j.data
        };
...
STK.register("common.setting.password",
function(a) {
    var b = {
        E01: "",
...
STK.register("common.setting.activation",
function(a) {
    var b = {
        E01: "",
        E02: "#L{请输入短信激活码}",
...
STK.register("common.setting.timer",
function(a) {
    var b = {
        ss: 1,
        mm: 60,
...
STK.register("common.dialog.authentication",
function(a) {
    return function(b) {
        ...
        j = {
            ...
            show: function() {
                ...
                h || a.kit.io.cssLoader("style/css/module/layer/layer_check_identity.css", "js_style_css_module_layer_check_identity",
                function() {
                    h = !0
                });
                f.show().setMiddle();
...
STK.register("common.layer.ioError",
function(a) {
    var b = a.kit.extra.language,
    c;
...
STK.register("common.setting.jumpStatics",
function(a) {
    var b = function(a) {
    ...
    return function(c) {
        ...
        if (a.isNode(e) && f) {
            var g = function(b) {
                ...
                var e = d && c.judge(d); ! e || ((new Image).src = c.analyticsLink)
            };
...
STK.register("common.form.rejectFake",
function(a) {
    return function(b) {
        var c = {},
        d, e = {
...
STK.register("common.form.template",
function(a) {
    var b = a.kit.extra.language,
    c = {
...
STK.register("common.dialog.mobilePincode",
function(a) {
    var b = a.common.trans.form,
    c = a.kit.extra.language;
    return function() {
        var d, e, f, g, h = {},
        i = 5e3,
        j = ["normal", "timeout", "over", "error", "success"],
        k = c("#L{确认}"),
        l = "",
        m,
        n,
        o = {
            ...
            dialog: {
                ...
                setMiddle: function() {
                    ...
                    d.setPosition({
                        l: (b.width - c.w) / 2,
                        t: (b.height - c.h) / 2 + a.core.util.scrollPos().top
                    })
                },
                show: function() {
                    d.getOuter().setAttribute("id", "quick_register" + (e ? "_" + e: ""));
                    d.setTitle(k);
                    d.setContent(l);
                    d.show();
                    setTimeout(function() {
                ...
                eveShow: function() {
                    setTimeout(o.dialog.show, 0);
                    a.custEvent.remove(d, "hide", o.dialog.eveShow)
                },
                bind: function() {
                    f = a.core.evt.delegatedEvent(d.getOuter());
                    for (var b in o.dEvts) f.add(b, "click", o.dEvts[b])
                },
                changeTo: function(b) {
                    var c = a.sizzle('[node-type="' + b + '"]', d.getInner())[0];
                    if (a.isNode(c)) {
                        a.setStyle(c, "display", "");
                        var e;
                        for (var f = 0; f < j.length; f++) {
                            if (b == j[f]) continue;
                            e = a.sizzle('[node-type="' + j[f] + '"]', d.getInner())[0];
                            a.isNode(e) && a.setStyle(e, "display", "none")
                        }
                    }
                }
            },
            bind: function() {
                a.custEvent.define(p, ["start", "success", "change"]);
                for (var b in o.cEvts) a.custEvent.add(p, b, o.cEvts[b])
            },
            cEvts: {
                start: function(b, c) {
                    e = c.entry;
                    h = {
                        entry: c.entry,
                        mobile: a.kit.extra.rsa(c.mobile, $CONFIG.key, $CONFIG.key_plus)
                    };
                    o.getPin()
                }
            },
            ...
            getPin: function() {
                o.stopPin();
                m = b.getTrans("get_pin_code", {
                    onComplete: o.handle.getPin,
                    onFailed: function() {}
                }).request(h)
            },
            stopPin: function() {
            ...
            startPin: function() {
                ...
                n = setTimeout(o.pin, i)
            },
            pin: function() { (new Date).getTime() / 1e3 - g > 1800 ? o.dialog.changeTo("timeout") : m = b.getTrans("check_pin_code", {
                    onComplete: o.handle.checkPin,
                    onFailed: function() {}
                }).request(h)
            },
            handle: {
                getPin: function(a) {
                    if (a.code == "100000") {
                        l = a.data.html;
                        o.dialog.show();
                        h.vcode = a.data.vcode;
                        o.dialog.changeTo("normal");
                        o.startPin()
                    }
                },
                checkPin: function(b) {
                    switch (b.code) {
                    case "100000":
                        o.dialog.changeTo("success");
                        a.custEvent.fire(p, "success", {
                            pincode: b.data.pincode
                        });
                        break;
                    case "100001":
                        o.dialog.changeTo("over");
                        break;
                    case "100012":
                        n = setTimeout(o.pin, i);
                        break;
        ...
        p = {
            ...
            destroy: function() {
                d.destroy();
                a.custEvent.undefine(p, ["check", "success", "change"])
            }
        };
        o.init();
        return p
...
STK.register("pl.register.mobile.source.submitBtn",
function(a) {
    var b = a.kit.extra.language;
    return function(c, d) {
        d = a.parseParam({
...
STK.register("pl.register.mobile.source.main",
function(a) {
    var b = a.common.form.template,
    c = a.common.trans.form,
    d = a.common.trans.account,
    e = a.common.dialog.loginLayer,
    f = a.common.layer.ioError,
    g = a.kit.extra.language,
    h = a.pl.register.mobile.source.submitBtn;
    return function(d) {
        var i = window.location.host == "www.weibo.com" ? "www.weibo.com": "weibo.com",
        j = {},
        k,
        l,
        m,
        ...
        p = 0,
        q,
        r = ["newmobilesea", "password", "activation"],
        s,
        t = {
            formCheck: function(a, b) {
                x(b)
            },
            changeZone: function(b, c) {
                if (c == "0086" && $CONFIG.closeSendsms == "1") {
                    a.setStyle(l.btn_check_pincode, "display", "");
                    a.setStyle(l.btn_submit, "display", "none");
                    a.setStyle(l.activation_wrapper, "display", "none");
                    k.ctls.activation.disabled(1)
                } else {
                    a.setStyle(l.btn_check_pincode, "display", "none");
                    a.setStyle(l.btn_submit, "display", "");
                    a.setStyle(l.activation_wrapper, "display", "");
                    k.ctls.activation.disabled(0)
                }
            }
        },
        u = a.common.form.rejectFake(),
        v,
        w = {
            btn_check_pincode: function(b) {
                a.preventDefault(b.evt);
                var c = k.check();
                if (c) {
                    var d = k.getData();
                    d.rejectFake = u.getData();
                    var e = a.core.json.merge(b.data, d);
                    weiboRegController.setPostData(e);
                    e.entry && weiboRegController.setEntry(e.entry);
                    a.custEvent.fire(s, "start", {
                        mobile: e.username,
                        entry: e.entry
                    })
                } else x(k.states(), !0)
		    ...
		    console.error('in btn_submit' + f.entry + f)
            ...
            btn_sms_activation: function(b) {
                a.preventDefault();
                if (k.ctls.newmobilesea.msg.state && k.ctls.newmobilesea.msg.type == "ok") {
                    b = b.data || {};
                    b.value = k.ctls.newmobilesea.value();
                    b.zone = k.ctls.newmobilesea.getZone();
                    var d = function(a) {
                        l.sms_timer.innerHTML = a.last;
                        l.btn_sms_activation_disable.style.display = a.last == 0 ? "none": "";
                        l.btn_sms_activation.style.display = a.last == 0 ? "": "none";
                        if (p == 5) {
                            l.btn_sms_activation.className = l.btn_sms_activation_disable.className;
                            m.remove("btn_sms_activation", "click")
                        }
                    };
                    o = a.common.setting.timer({
                        time: 59
                    },
                    d);
                    o.start();
                    var e = k.ctls.activation.dataType.get("msg");
                    e.type = "tip";
                    e.msg = g("#L{激活码发送成功，60秒内未收到请重新获取}");
                    c.request("checkform", {
                        onSuccess: function(b) {++p;
                            x({
                                activation: e
                            });
                            p == 5 && a.ui.confirm(g("#L{如仍未收到激活码，请使用电子邮箱注册}"), {
                                OK: function() {
                                    a.preventDefault();
                                    window.location.href = "http://" + i + "/signup/mobile.php?lang=zh-cn"
                                }
                            })
                        },
                        onError: function(a) {
                    ...
                    b)
                } else a.kit.extra.textareaUtils.setCursor(l.newmobilesea)
            },
        ...
        y = {
            ...
            pars: function() {},
            build: function() {
                k = a.common.setting.form(d);
                l = a.kit.dom.parseDOM(k.domList);
                for (var b = 0,
                e, f, g, j = r.length; b < j; b++) {
                    e = r[b];
                    f = l[e];
                    if (l[e] && a.common.setting[e]) {
                        g = a.queryToJson(f.getAttribute("action-data") || "");
                        g.hook = k;
                        g.proxy = c;
                        g.iokey = "checkform";
                        var m = a.common.setting[e](f, g);
                        k.add(e, m)
                    }
                }
                k.ctls.newmobilesea.getZone() == "0086" && $CONFIG.closeSendsms == "1" && k.ctls.activation.disabled(1);
                a.custEvent.add(k.ctls.newmobilesea, "change", t.changeZone);
                n = a.common.setting.textCopy(d);
                q = a.common.setting.jumpStatics({
                    analyticsLink: "http://" + i + "/signup/v5/jumplog?from=mobile"
                });
                v = h(l.btn_submit);
                s = a.common.dialog.mobilePincode();
                a.custEvent.add(s, "success",
                function(a, b) {
                    weiboRegController.setVerifyData(b);
                    weiboRegController.setRegisterCallback(function(a) {
                        s.hide();
                        a.code == "100000" ? window.top.location.href = a.href: a.formresult && x(a.formresult)
                    });
                    weiboRegController.register()
                })
            },
            bind: function() {
                a.custEvent.define(k, ["check"]);
                a.custEvent.add(k, "check", t.formCheck);
                m = a.delegatedEvent(d);
                for (var b in w) m.add(b, "click", w[b]);
                weiboRegController.init({
                    entry: "",
                    lang: window.$CONFIG && window.$CONFIG.lang || "zh-cn",
                    feedBackUrl: "http://" + i + "/signup/v5/ajaxreg",
                    ...
                    callback: function(b) {
                        ...
                        if (b.code == "100000") window.location.href = b.href;
                            ...
                            var c = b.formresult || {};
                            for (var d in c) k.ctls[d] && k.ctls[d].setMsg(c[d]);
                            c && x(c)
                        }
                    }
                })
            ...
            initPlugin: function() {},
            destroy: function() {
                a.custEvent.remove(k, "check", t.formCheck);
                m.destroy();
                n.destroy();
                q.destroy()
            }
...
STK.pageletM.register("pl.register.mobile.index",
function(a) {
    return a.pl.register.mobile.source.main(a.E("pl_account_regmobile"))
});
STK.register("pl.register.sidebar.source.main",
function(a) {
    return function(b) {
        var c, d = {
            init: function() {
...
STK.pageletM.register("pl.register.sidebar.index",
function(a) {
    return a.pl.register.sidebar.source.main(a.E("pl_register_sidebar"))
});
STK.pageletM.start();
console.error('error init'+7788)
